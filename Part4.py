...
def monteCarlo(numberSimulations):
    ...
    for i in range(numberSimulations):
        ...
        for j in range(24):
            ...
            droppedCallsForThisHour = runSimulation(3600, len(callsForThisHour), 42, callsForThisHour)  #returns an actual integer value for the number of calls dropped in a given simulation run
